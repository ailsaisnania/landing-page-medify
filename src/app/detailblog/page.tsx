...
export default function blog (){
    return(
        ...
        <div className="bg-[url(/blog/yaallah.jpg)] h-[750px] w-full relative">
        <div className="absolute top-[40%] px-4 py-3 text-center w-full">
            <h1 className="text-medify-white font-semibold text-6xxl"> Lorem Ipsum : Dolor sit Amet Constecture Adipising Elite  </h1>

        </div>
        </div> 

        
        <div className="px-24 flex flex-col-2 items-center gap-5 mt-12">
        ...
        <div className="body-2 px-24 py-4 text-justify">
        ...
        <div className="grid grid-flow-row justify-center items-center">
            <div>
            <img src="/blog/pict1.svg"alt=""/>
            </div>
            <p className="text-base text-center">Gambar Suntikan</p>

        </div>

        <div className="body-2 px-24 py-5 text-justify">
